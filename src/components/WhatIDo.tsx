        ...
        <div className="what-box-in">
          ...
          <div className="what-content what-noTouch" ref={(el) => setRef(el, 0)}>
            ...
            <div className="what-content-in">
              ...
              <p>
                Building intelligent systems using deep learning, computer
                vision, and NLP for healthcare, agriculture, and education.
              </p>
          ...
          <div className="what-content what-noTouch" ref={(el) => setRef(el, 1)}>
            ...
            <div className="what-content-in">
              ...
              <p>
                End-to-end web applications with Python backends, REST APIs,
                and modern frontends built for fast iteration and deployment.
              </p>
              <h5>Skillset &amp; tools</h5>
              <div className="what-content-flex">
